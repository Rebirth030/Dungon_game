...
public class PlayerOne {
	...
	public static void update() {
		...
		x = Game.constrain(x + ((velX != 0 && velY != 0) ? velX / Math.sqrt(2) : velX), 0, LevelOne.mapWidth - playerWidth);
		y = Game.constrain(y + ((velX != 0 && velY != 0) ? velY / Math.sqrt(2) : velY), 0, LevelOne.mapHeight - playerHeight);
		accX = 0;
		accY = 0;
